...
enum _lv_part_t {
    LV_PART_MAIN         = 0x000000,   /**< 类似背景的矩形*/
    LV_PART_SCROLLBAR    = 0x010000,   /**< 滚动条*/
    LV_PART_INDICATOR    = 0x020000,   /**< 指示器，例如滑块、条、开关或复选框的勾选框*/
    LV_PART_KNOB         = 0x030000,   /**< 就像抓把手来调整数值一样*/
    LV_PART_SELECTED     = 0x040000,   /**< 指示当前选择的选项或部分*/
    LV_PART_ITEMS        = 0x050000,   /**< 如果小部件具有多个相似元素（例如表格单元格），则使用*/
    LV_PART_CURSOR       = 0x060000,   /**< 标记一个特定的位置，例如文本区域的光标或图表上的位置*/

    LV_PART_CUSTOM_FIRST = 0x080000,    /**< 自定义小部件的扩展点*/

    LV_PART_ANY          = 0x0F0000,    /**< 特殊值可用于某些功能，以针对所有零件*/
};
