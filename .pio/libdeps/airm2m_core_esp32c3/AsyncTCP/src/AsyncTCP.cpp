...
static bool _start_async_task()
{
    ...
    if (!_async_service_task_handle)
    {
        xTaskCreatePinnedToCore(_async_service_task, "async_tcp", 8192 * 2, NULL, 1, &_async_service_task_handle, CONFIG_ASYNC_TCP_RUNNING_CORE);
        if (!_async_service_task_handle)
        {
            return false;
